...
<template>
    <NuxtImg
        ...
        :src="movie.backdrop_path ? `/img${ movie?.backdrop_path }` : '/background.jpg'"
        class="fixed top-0 left-0 w-screen h-screen brightness-[80%]"
    />
    <div v-else class="fixed top-0 left-0 w-screen h-screen gradient"></div>
